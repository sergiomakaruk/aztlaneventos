  ...
  <div class="form-group">
    ...
    <div class="col-sm-8">
		<select class="form-control"  name="tipoEvento" >
			<option>----------&Uacute;NICA QUE FUNCIONA PARA IMPRIMIR LISTA------------------------------------------------------------</option>
			<option value="3" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 3 || !isset($evento))echo 'selected';?> >3 // DOM 3/12 - 19 hs >> Conflictos de Pareja</option>
			<option>----------------------------------------------------------------------</option>
			...
			<option>----------ORDENADOS POR FECHA Y HORA------------------------------------------------------------</option>
			<option value="26" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 26)echo 'selected';?> >26 // DOM 19/11 - 18:30 hs >> Mejorá la Salud</option>
			<option value="120" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 120)echo 'selected';?> >120 // DOM 3/12 - 17:30 hs >> La Práctica del Relato</option>
			<option value="118" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 118)echo 'selected';?> >118 // SÁB 25/11 - 19:30 hs >> Aprendiendo a comer</option>
			<option value="34" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 34)echo 'selected';?> >34 // DOM 17/12 - 19 hs >> Cómo alcanzar la Abundancia</option>
			<option value="111" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 111)echo 'selected';?> >111 // LUN 18/12 - 19 hs >> Preparándonos para el 2018</option>
			<option value="33" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 33)echo 'selected';?> >33 // MAR 9/01 - 19 hs >> Autoconocimiento Socrático</option>
			<option value="20" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 20)echo 'selected';?> >20 // MAR 9/01 - 19 hs >> Numerología Nivel 1</option>
			<option value="108" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 108)echo 'selected';?> >108 // MIE 10/01 - 19 hs >> Numerología Nivel 2</option>
			<option value="117" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 117)echo 'selected';?> >117 // MAR 23/01 - 19 hs >> Taller de Mandala Nivel 1</option>
			<option value="101" <?php if(isset($evento) && $evento->tipoEvento_idTipo == 101)echo 'selected';?> >101 // MIE 24/01 - 19 hs >> Taller de Mandala Nivel 2</option>
			<option>----------FUERA DE USO (al menos de los eventos activos en Facebook------------------------------------</option>
