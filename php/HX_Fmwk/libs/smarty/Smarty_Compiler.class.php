...
/* $Id: Smarty_Compiler.class.php,v 1.1 2009-04-03 14:11:40 hugo Exp $ */
...
class Smarty_Compiler extends Smarty {
	...
	*/
	...
	function _compile_file($resource_name, $source_content, &$compiled_content)
	{
		...
		if(strtolower(substr($resource_name,strlen($resource_name)-4))!=".xml"){
			$iniTemplate="\n<!-- ".strtr(urlencode($resource_name), array('%2F'=>'/', '%3A'=>':'))." (creado en: ".strftime("%Y-%m-%d %H:%M:%S").")-->\n";

		}
		$finTemplate="\n<!-- ".strtr(urlencode($resource_name), array('%2F'=>'/', '%3A'=>':'))." -->\n";

		$template_header .= $iniTemplate;
		...
		$compiled_content = $template_header . $compiled_content . $finTemplate;
		return true;
	}
